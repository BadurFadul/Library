...
namespace Library.src.Library
{
    public class TextBook : Book, IBorrowable, IPrintable
    {
        ...
        public TextBook(string title, string author, string isbn, int publicationyear, int pageCount, bool canborrow = true, bool canprint = true) : base(title, author, isbn, publicationyear, canborrow, canprint)
        {
            PageCount = pageCount;
        }
        ...
        {
            Console.WriteLine("Text book can be borrowed");
        }
        ...
        {
            Console.WriteLine("TextBooks can be returned");
        }
